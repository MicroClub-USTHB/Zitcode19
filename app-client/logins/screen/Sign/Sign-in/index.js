    ...
    render(){
        return(
            <View style={Styles.container}>
                ...
                <TouchableOpacity style={{backgroundColor:PRIMARY, width:'50%', height:50 ,borderRadius:50 , alignItems:'center',justifyContent:'center'}} onPress={()=>this.props.navigation.navigate('Menu')}  >
...
export default withNavigation(In)